...
@Component({
  selector: 'app-svg',
  template: ` @switch (name()) { @case ('home') {
    <svg
    ...
    >
      ...
      <path d="M9.015 16a1 1 0 0 1 -1 1a1.001 1.001 0 1 1 -.005 -2c.557 0 1.005 .448 1.005 1" /></svg
    >} @case ('buildings') {<svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
